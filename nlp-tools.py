...
=======
     user_input = re.sub(r'([က-အ])([ံ]|[ျ-ှ]|[ေ]|[ါ-ူ]|[က-အ]်)',r'\1အ\2',user_input.strip())
     #user_input = re.sub(r'([က-အ]([ျ-ှ]){1,})',r'\1အ',user_input);
     #to_normal =  re.sub(r'([က-အ][ျ-ှ]{1,})အ',r'\1', user_input);
     to_normal =  re.sub(r'([က-အ])အ([ံ]|[ျ-ှ]|[ေ]|[ါ-ူ]|[က-အ]်)',r'\1\2', user_input)
>>>>>>> 18ad0e8ebc189a4c5ff46a28031e632d7e0b4cfe
