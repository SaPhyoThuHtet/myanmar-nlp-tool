...
if (option == 'multilingual_semi_syllable_break'):
    ...
    st.write("\n")
    st.write("Description: Semi-syllable-break for Sinhala, Tamil, Burmese (Myanmar), Pali (Myanmar), Shan, Rakhine, Pa-Oh, and Mon, Word break for English, Char break for other language")
